                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <div class="container mt-3 pb-3">
                                    ...
                                    <form action="<?= base_url('/pengurus/simpan') ?>" method="POST" id="exampleModalLabel">
                                        ...
                                        <input type="text" name="jabatan" class="form-control mt-3" placeholder="Jabatan" required>
                                        <input type="email" name="email" class="form-control mt-3" placeholder="Email" required>
                                        <input type="number" name="no_hp" class="form-control mt-3" placeholder="No HP" required>
                                        <input type="text" name="gender" class="form-control mt-3" placeholder="Jenis Kelamin" required>
