                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <div class="container mt-3 pb-3">
                                    ...
                                    <h2 class="text-center text-primary">Nama Tim Sukses Dari Partai PSI</h2>
                                    <a href="<?= base_url('partai/tambah/') ?>" class="btn btn-primary ms-2">+Tambah Data</a>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($par as $m) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $m['no_tps'] ?></td>
                                                        <td>
                                                            <a href="<?= base_url('partai/edit/' . $m['nik']) ?>" class="btn btn-warning mr-2">Edit</a>
                                                            <a href="<?= base_url('partai/delete/' . $m['nik']) ?>" class="btn btn-danger delete-link">Hapus</a>
